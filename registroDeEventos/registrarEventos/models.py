...
class Evento(models.Model):
    nombre = models.CharField(max_length=100) # Respetando la restricción de que 'nombre' contenga como máximo 100 caracteres.
...
class Participante(models.Model):
    ...
    correo = models.EmailField() # Respetando la restricción de que se ingrese un email respetando su formato, usando @.
